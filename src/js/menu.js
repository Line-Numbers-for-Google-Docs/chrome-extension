    ...
    dialogMenu.addSection("Help", [() => {
        ...
        help.innerHTML = `
            <ul style="margin-left: -15px">
                <li><a href="https://docs.linenumbers.app/settings" target="_blank">Description of Settings</a></li>
                <li><a href="https://docs.linenumbers.app/faq" target="_blank">Frequently Asked Questions</a></li>
                <!-- <li><a>Report a Bug or Request a Feature</a></li> -->
                <li><a href="https://linenumbers.app/contact" target="_blank">Contact Developer</a></li>
            </ul>`
        return help
    }]);
