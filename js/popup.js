$(document).ready(function () {
  ...
  chrome.storage.local.get(["rightNumbering"], function (result) {
    if (result["rightNumbering"]) {
      $("#right-numbering").attr('checked', 'checked');
    }
  });
  ...
  $("#right-numbering").change(function () {
    //Save enabled boolean
    chrome.storage.local.set({
      "rightNumbering": $("#right-numbering").is(':checked')
    }, function () {
      console.log('rightNumbering value saved locally.');
      refresh();
    });
  });
